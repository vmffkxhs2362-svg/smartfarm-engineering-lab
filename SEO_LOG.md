...
| 측정 기간 | 총 사용자 수 | 세션 수 | 페이지뷰 | 직접 유입 (Direct) | 피드백 클릭 | 비고 |
| :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| 2026-06-12 ~ 2026-06-18 | 51 | 65 | 216 | 49 | 3 | 초기 런칭 및 테스트 기간 |
| 2026-06-19 ~ 2026-06-25 | 33 | 38 | 190 | 28 | 1 | 유입 하락 국면 진입 |
| 2026-06-26 ~ 2026-07-02 | 9 | 12 | 434 | 5 | 0 | 도메인 연동 및 고관여 패턴 발견 |
| 2026-07-03 ~ 2026-07-09 | 7 | 14 | 260 | 4 | 0 | 유기 검색 유입 전환 국면 |
| 2026-07-24 ~ 2026-07-30 | 4 | 4 | 68 | 1 (Google Organic) | 0 | 유기적 검색 유입(Google Organic) 및 AI 검색 인용 기반 확장 확인 |

### 2026-07-30 (Schema.org JSON-LD & AEO AI 검색 엔진 노출 최적화)
* **목적**: 억지 바이럴 없이 구글/네이버 유기적 검색(Organic SEO) 및 AI 검색 엔진(Perplexity, Gemini) 답변 출처 인용(Citation) 극대화.
* **변경 내역**:
  * **Schema.org JSON-LD**: `WebApplication` 스키마에 `inLanguage: ["ko", "en"]`, `publisher` 조직 정보, `url` 캐노니컬 구조화 데이터 주입 완료.
  * **Sitemap.xml**: 13개 전체 정적 HTML 페이지의 `<lastmod>`를 `2026-07-30`으로 최신화 후 구글 봇 재수집 준비 완료.

---
*마지막 업데이트: Antigravity AI Operations | 2026-07-30*
